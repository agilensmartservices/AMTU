...
{
    public class CreateFeedDocument
    {       
        ILog log = LogManager.GetLogger("Feed");

        private readonly string host;
        private const string createFeedDocumentResource = "feeds/2021-06-30/documents";
        ...
        public CreateFeedDocument(string _region)
        {
        ...
        public CreateFeedDocumentResponse Post(CreateFeedDocumentRequest createFeedDocumentRequest)
        {
            var endpoint = Path.Combine(host, createFeedDocumentResource);
            ...
            string requestJSON = JsonConvert.SerializeObject(createFeedDocumentRequest);
            ...
            {
                var responseObject = JsonConvert.DeserializeObject<CreateFeedDocumentResponse>(response.Content);
